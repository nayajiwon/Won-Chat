...
public class OauthControllerJiwonLocal {
    ...
    public RedirectView getNaverLoginScreen(){
        ...
        String loginUrl = loginServiceImpl.JiWon_Local_OnLy_requestNaverLoginScreenUrl();
    ...
    @GetMapping("/api/login/naver/menu")
    //public RedirectView getNaverLoginScreen(){
    public void getNaverLoginScreen(HttpServletResponse httpServletResponse) throws IOException {
    ...
    public void getNaverCallBack(HttpServletRequest http,  @RequestParam(value="code") String authCode, @RequestParam(value="state") String state) throws ParseException {
        ...
        /**jiwon local**/
        NaverUserDto user = loginServiceImpl.JiWon_Local_OnLy_requestNaverUserAccessToken(authCode, state);
