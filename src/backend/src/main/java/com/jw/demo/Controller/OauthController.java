...
public class OauthController {
    ...
    @Autowired
    NaverNaverLoginServiceImpl naverLoginServiceImpl;
    ...
    public RedirectView getNaverLoginScreen(){
        ...
        String loginUrl = naverLoginServiceImpl.requestNaverLoginScreenUrl();
    ...
    public void getNaverCallBack(HttpServletRequest http,  @RequestParam(value="code") String authCode, @RequestParam(value="state") String state) throws ParseException {
        ...
        UserDto user = naverLoginServiceImpl.requestNaverUserAccessToken(authCode, state);
        if(user == null){
        ...
        UserDto memberId = memberService.getUserbyId(ID);
